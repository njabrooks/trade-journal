...
```json
{ "success": true, "skill": "thesis", "summary": "<what changed>", "writes": [] }
```
...
when wiring thesis into an actual headless cron. The full skill instructions follow in `SKILL.md`._
