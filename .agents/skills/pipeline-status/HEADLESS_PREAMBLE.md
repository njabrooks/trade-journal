...
```json
{ "success": true, "skill": "pipeline-status", "summary": "<what changed>", "writes": [] }
```
...
when wiring pipeline-status into an actual headless cron. The full skill instructions follow in `SKILL.md`._
