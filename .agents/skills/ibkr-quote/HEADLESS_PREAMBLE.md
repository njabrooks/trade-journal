...
```json
{ "success": true, "skill": "ibkr-quote", "summary": "<what changed>", "writes": [] }
```
...
when wiring ibkr-quote into an actual headless cron. The full skill instructions follow in `SKILL.md`._
