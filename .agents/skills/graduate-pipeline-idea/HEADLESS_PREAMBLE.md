# HEADLESS MODE — Graduate Pipeline Idea
...
```json
{ "success": true, "skill": "graduate-pipeline-idea", "summary": "<what changed>", "writes": [] }
```
...
when wiring graduate-pipeline-idea into an actual headless cron. The full skill instructions follow in `SKILL.md`._
