...
```json
{ "success": true, "skill": "process-note", "summary": "<what changed>", "writes": [] }
```
...
when wiring process-note into an actual headless cron. The full skill instructions follow in `SKILL.md`._
