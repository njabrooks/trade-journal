# HEADLESS MODE — Stage 3 Map Unknowns
...
```json
{ "success": true, "skill": "stage-3-map-unknowns", "summary": "<what changed>", "writes": [] }
```
...
when wiring stage-3-map-unknowns into an actual headless cron. The full skill instructions follow in `SKILL.md`._
