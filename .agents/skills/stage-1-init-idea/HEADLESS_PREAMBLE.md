# HEADLESS MODE — Stage 1 Init Idea
...
```json
{ "success": true, "skill": "stage-1-init-idea", "summary": "<what changed>", "writes": [] }
```
...
when wiring stage-1-init-idea into an actual headless cron. The full skill instructions follow in `SKILL.md`._
