...
```json
{ "success": true, "skill": "maintenance", "summary": "<what changed>", "writes": [] }
```
...
when wiring maintenance into an actual headless cron. The full skill instructions follow in `SKILL.md`._
