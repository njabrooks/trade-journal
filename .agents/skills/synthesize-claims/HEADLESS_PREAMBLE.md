# HEADLESS MODE — Synthesize Claims
...
```json
{ "success": true, "skill": "synthesize-claims", "summary": "<what changed>", "writes": [] }
```
...
when wiring synthesize-claims into an actual headless cron. The full skill instructions follow in `SKILL.md`._
