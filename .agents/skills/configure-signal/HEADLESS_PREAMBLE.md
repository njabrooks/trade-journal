# HEADLESS MODE — Configure Signal
...
```json
{ "success": true, "skill": "configure-signal", "summary": "<what changed>", "writes": [] }
```
...
when wiring configure-signal into an actual headless cron. The full skill instructions follow in `SKILL.md`._
