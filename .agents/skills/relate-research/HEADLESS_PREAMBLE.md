...
```json
{ "success": true, "skill": "relate-research", "summary": "<what changed>", "writes": [] }
```
...
when wiring relate-research into an actual headless cron. The full skill instructions follow in `SKILL.md`._
