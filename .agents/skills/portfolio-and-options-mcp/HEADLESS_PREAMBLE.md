# HEADLESS MODE — Portfolio And Options Mcp
...
```json
{ "success": true, "skill": "portfolio-and-options-mcp", "summary": "<what changed>", "writes": [] }
```
...
when wiring portfolio-and-options-mcp into an actual headless cron. The full skill instructions follow in `SKILL.md`._
