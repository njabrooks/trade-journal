...
```json
{ "success": true, "skill": "gateway", "summary": "<what changed>", "writes": [] }
```
...
when wiring gateway into an actual headless cron. The full skill instructions follow in `SKILL.md`._
