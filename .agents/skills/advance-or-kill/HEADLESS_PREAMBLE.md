...
```json
{ "success": true, "skill": "advance-or-kill", "summary": "<what changed>", "writes": [] }
```
...
when wiring advance-or-kill into an actual headless cron. The full skill instructions follow in `SKILL.md`._
