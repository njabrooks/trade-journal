...
```json
{ "success": true, "skill": "pull-portfolio", "summary": "<what changed>", "writes": [] }
```
...
when wiring pull-portfolio into an actual headless cron. The full skill instructions follow in `SKILL.md`._
