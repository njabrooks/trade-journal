...
```bash
cd /Users/home-hub/projects/trade-journal/.claude/worktrees/mystifying-shirley-8a091a
...
```json
{ "success": true, "skill": "morning-brief", "summary": "<what changed>", "writes": [] }
```
...
when wiring morning-brief into an actual headless cron. The full skill instructions follow in `SKILL.md`._
