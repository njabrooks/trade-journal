# HEADLESS MODE — Stage 5 Express Thesis
...
```json
{ "success": true, "skill": "stage-5-express-thesis", "summary": "<what changed>", "writes": [] }
```
...
when wiring stage-5-express-thesis into an actual headless cron. The full skill instructions follow in `SKILL.md`._
