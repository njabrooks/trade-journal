# HEADLESS MODE — Stage 4b Synthesize Evidence
...
```json
{ "success": true, "skill": "stage-4b-synthesize-evidence", "summary": "<what changed>", "writes": [] }
```
...
when wiring stage-4b-synthesize-evidence into an actual headless cron. The full skill instructions follow in `SKILL.md`._
