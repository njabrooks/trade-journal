...
```json
{ "success": true, "skill": "backfill-claims", "summary": "<what changed>", "writes": [] }
```
...
when wiring backfill-claims into an actual headless cron. The full skill instructions follow in `SKILL.md`._
