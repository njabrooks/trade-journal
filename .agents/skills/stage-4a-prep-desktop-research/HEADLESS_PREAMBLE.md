# HEADLESS MODE — Stage 4a Prep Desktop Research
...
```json
{ "success": true, "skill": "stage-4a-prep-desktop-research", "summary": "<what changed>", "writes": [] }
```
...
when wiring stage-4a-prep-desktop-research into an actual headless cron. The full skill instructions follow in `SKILL.md`._
