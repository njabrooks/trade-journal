...
```json
{ "success": true, "skill": "visser-scan", "summary": "<what changed>", "writes": [] }
```
...
when wiring visser-scan into an actual headless cron. The full skill instructions follow in `SKILL.md`._
