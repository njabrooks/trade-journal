# HEADLESS MODE — Stage 4a Research Unknown
...
```json
{ "success": true, "skill": "stage-4a-research-unknown", "summary": "<what changed>", "writes": [] }
```
...
when wiring stage-4a-research-unknown into an actual headless cron. The full skill instructions follow in `SKILL.md`._
