...
```json
{ "success": true, "skill": "thesis-review", "summary": "<what changed>", "writes": [] }
```
...
when wiring thesis-review into an actual headless cron. The full skill instructions follow in `SKILL.md`._
