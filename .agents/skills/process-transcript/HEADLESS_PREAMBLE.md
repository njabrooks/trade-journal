# HEADLESS MODE — Process Transcript
...
```json
{ "success": true, "skill": "process-transcript", "summary": "<what changed>", "writes": [] }
```
...
when wiring process-transcript into an actual headless cron. The full skill instructions follow in `SKILL.md`._
