...
```json
{ "success": true, "skill": "options-advisor", "summary": "<what changed>", "writes": [] }
```
...
when wiring options-advisor into an actual headless cron. The full skill instructions follow in `SKILL.md`._
