# HEADLESS MODE — Finalize For Upload
...
```json
{ "success": true, "skill": "finalize-for-upload", "summary": "<what changed>", "writes": [] }
```
...
when wiring finalize-for-upload into an actual headless cron. The full skill instructions follow in `SKILL.md`._
