# HEADLESS MODE — Analyze Vol Curve
...
```json
{ "success": true, "skill": "analyze-vol-curve", "summary": "<what changed>", "writes": [] }
```
...
when wiring analyze-vol-curve into an actual headless cron. The full skill instructions follow in `SKILL.md`._
