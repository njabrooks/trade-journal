...
```json
{ "success": true, "skill": "thesis-observe", "summary": "<what changed>", "writes": [] }
```
...
when wiring thesis-observe into an actual headless cron. The full skill instructions follow in `SKILL.md`._
