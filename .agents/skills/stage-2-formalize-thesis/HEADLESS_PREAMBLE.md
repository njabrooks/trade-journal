# HEADLESS MODE — Stage 2 Formalize Thesis
...
```json
{ "success": true, "skill": "stage-2-formalize-thesis", "summary": "<what changed>", "writes": [] }
```
...
when wiring stage-2-formalize-thesis into an actual headless cron. The full skill instructions follow in `SKILL.md`._
