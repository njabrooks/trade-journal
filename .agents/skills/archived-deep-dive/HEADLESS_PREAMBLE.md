# HEADLESS MODE — Archived Deep Dive
...
```json
{ "success": true, "skill": "archived-deep-dive", "summary": "<what changed>", "writes": [] }
```
...
when wiring archived-deep-dive into an actual headless cron. The full skill instructions follow in `SKILL.md`._
