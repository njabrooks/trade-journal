# HEADLESS MODE — Paperclip Backlog
...
```json
{ "success": true, "skill": "paperclip-backlog", "summary": "<what changed>", "writes": [] }
```
...
when wiring paperclip-backlog into an actual headless cron. The full skill instructions follow in `SKILL.md`._
