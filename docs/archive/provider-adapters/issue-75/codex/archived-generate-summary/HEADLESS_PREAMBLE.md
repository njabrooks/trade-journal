# HEADLESS MODE — Archived Generate Summary
...
```json
{ "success": true, "skill": "archived-generate-summary", "summary": "<what changed>", "writes": [] }
```
...
when wiring archived-generate-summary into an actual headless cron. The full skill instructions follow in `SKILL.md`._
