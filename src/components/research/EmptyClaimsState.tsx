  ...
  return (
    <div className="bg-card rounded-lg border p-12">
      <div className="max-w-2xl mx-auto text-center">
        ...
        {/* Workflow Steps */}
        <div className="bg-muted rounded-lg border p-6 mb-8 text-left">
          ...
          <ol className="space-y-3 text-sm text-foreground">
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                <strong>Run</strong> <code className="px-2 py-0.5 bg-muted rounded text-xs font-mono">/process-transcript</code> in local Claude Code session
              </span>
            </li>
            <li className="flex items-start gap-3">
              <span className="flex-shrink-0 flex items-center justify-center w-6 h-6 rounded-full bg-blue-100 text-blue-700 dark:bg-blue-900/30 dark:text-blue-300 font-semibold text-xs">
              ...
              <span>
                <strong>Upload</strong> the generated audit file with <code className="px-2 py-0.5 bg-muted rounded text-xs font-mono">/finalize-for-upload</code>
              </span>
            </li>
          </ol>
        </div>
