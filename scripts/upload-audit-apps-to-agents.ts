    ...
    const claimsStructure = {
      main_claims: [
        // We'll populate a few examples to test the structure
        {
          ...
          grounds: 'Risk-on indicators rising: MSCI World ex-US up, industrial commodities higher, dollar weakness. PMIs overlaid with risk-growth index showing correlation.',
          warrant: 'The shift from centralized cloud training to distributed inference (edge devices, robotics, on-premise AI) requires massive hardware buildout across enterprises',
        ...
        },
        {
          ...
          grounds: 'Sam Altman: "Enterprise inflection has arrived"; GPT-5.2 achieving 70-74% of knowledge work tasks at expert level',
          warrant: 'Apps were built for a world where computers couldn\'t think; agents are built for a world where they can',
      ...
      evidence_claims: [
        {
          ...
          grounds: 'MACD sell signal in the dollar, combined with MSCI World ex-US strength and rising industrial commodities',
        ...
        },
        {
          ...
          grounds: 'Risk-growth index overlaid with US PMIs/ISM PMI showing correlation',
          confidence: 'medium' as const,
          supports_main_claims: ['claim-1'],
        },
      ],
