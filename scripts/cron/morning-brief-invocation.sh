...
RESULT_SCHEMA='{"type":"object","additionalProperties":false,"properties":{"success":{"type":"boolean"},"briefDate":{"type":"string"},"freshness":{"type":"object","additionalProperties":false,"properties":{"thesisObservation":{"type":"object","additionalProperties":false,"properties":{"status":{"type":"string","enum":["current","stale","missing"]},"observedAt":{"type":["string","null"]}},"required":["status","observedAt"]},"maintenance":{"type":"object","additionalProperties":false,"properties":{"status":{"type":"string","enum":["current","stale","missing"]},"observedAt":{"type":["string","null"]}},"required":["status","observedAt"]},"optionsAdvice":{"type":"object","additionalProperties":false,"properties":{"status":{"type":"string","enum":["current","stale","missing"]},"observedAt":{"type":["string","null"]}},"required":["status","observedAt"]},"portfolio":{"type":"object","additionalProperties":false,"properties":{"status":{"type":"string","enum":["current","stale","missing"]},"observedAt":{"type":["string","null"]}},"required":["status","observedAt"]},"decisions":{"type":"object","additionalProperties":false,"properties":{"status":{"type":"string","enum":["current","stale","missing"]},"observedAt":{"type":["string","null"]}},"required":["status","observedAt"]},"calendar":{"type":"object","additionalProperties":false,"properties":{"status":{"type":"string","enum":["current","stale","missing"]},"observedAt":{"type":["string","null"]}},"required":["status","observedAt"]}},"required":["thesisObservation","maintenance","optionsAdvice","portfolio","decisions","calendar"]},"headline":{"type":"string"},"attention":{"type":"array","maxItems":5,"items":{"type":"object","additionalProperties":false,"properties":{"rank":{"type":"integer"},"title":{"type":"string"},"why":{"type":"string"},"deepLink":{"type":"string"}},"required":["rank","title","why","deepLink"]}},"persisted":{"type":"boolean"},"write":{"anyOf":[{"type":"null"},{"type":"object","additionalProperties":false,"properties":{"id":{"type":"string"},"briefDate":{"type":"string"},"superseded":{"type":"boolean"}},"required":["id","briefDate","superseded"]}]},"unavailableInputs":{"type":"array","items":{"type":"string"}},"errors":{"type":"array","items":{"type":"string"}}},"required":["success","briefDate","freshness","headline","attention","persisted","write","unavailableInputs","errors"]}'
