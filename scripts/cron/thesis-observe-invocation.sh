...
RESULT_SCHEMA='{"type":"object","additionalProperties":false,"properties":{"success":{"type":"boolean"},"asOf":{},"thesesObserved":{"type":"array"},"signalsAssessed":{"type":"array"},"directives":{"type":"array"},"writes":{"type":"array"},"unavailableInputs":{"type":"array"},"errors":{"type":"array"}},"required":["success","asOf","thesesObserved","signalsAssessed","directives","writes","unavailableInputs","errors"]}'
