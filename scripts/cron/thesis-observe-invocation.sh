...
RESULT_SCHEMA='{"type":"object","additionalProperties":false,"properties":{"success":{"type":"boolean"},"asOf":{"type":"string"},"thesesObserved":{"type":"array","items":{"type":"object","additionalProperties":false,"properties":{"thesisId":{"type":"string"},"title":{"type":"string"}},"required":["thesisId"]}},"signalsAssessed":{"type":"array","items":{"type":"object","additionalProperties":false,"properties":{"signalId":{"type":"string"},"thesisId":{"type":"string"}},"required":["signalId"]}},"directives":{"type":"array","items":{"type":"object","additionalProperties":false,"properties":{"kind":{"type":"string"},"path":{"type":"string"}}}},"writes":{"type":"array","items":{"type":"object","additionalProperties":false,"properties":{"kind":{"type":"string"},"target":{"type":"string"}}}},"unavailableInputs":{"type":"array","items":{"type":"string"}},"errors":{"type":"array","items":{"type":"string"}}},"required":["success","asOf","thesesObserved","signalsAssessed","directives","writes","unavailableInputs","errors"]}'
